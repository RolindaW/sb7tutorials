...
#### Contents
[Step 1: Locate required files](#step1)  
[Step 2: Copy required files into new working directory](#step2)  
[Step 3: Create and setup a project template (wizard)](#step3)  
[Step 4: Create new project/solution using the project template](#step4)  
...
<a name="step2"/>
# Step 2: Copy required files into new working directory
...
<a name="step3"/>
# Step 3: Create and setup a project template (wizard)
...
<a name="step4"/>
# Step 4: Create new project/solution using the project template
...
How to create new project/solution in VS using superbible 7 framework.

Note: This guide can only be followed once steps in HOWTOBUILD.txt completed.
(glfw3 and superbible7 solutions generated - cmake - and compiled)

Note: It is more efficient to create first a project template (wizard) so it can be reused anytime new application is created (so it is not required to setup the whole new project on creation).
...
2 - Copy required files into a new working directory
...
3 - Create new C++ empty project/solution into working directory

Note: It is possible to create a project template (wizard) in order not to repeat these steps anytime we need to create a new project.
Default project template location for VS is: "C:\Users\eder\Documents\Visual Studio 2022\My Exported Templates"

C:\workspace\sb7tutorials\sb7tutorials\sb7tutorials.sln
C:\workspace\sb7tutorials\sb7tutorials\simpleapp

4 - Setup the project properly

Note: In VS, right-click project and select "Properties".
...
Configuration Properties > VC++ Directories > General > Include Directories
Add two lines:
- C:\workspace\sb7tutorials\include
- C:\workspace\sb7tutorials\extern\glfw-3.0.4\include
...
Description: Required by sb7 header file, in order to use windows. If not, unix is expected.
...
5 - Add stuff into your project (up to you), compile and run it!
