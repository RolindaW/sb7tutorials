...
public:
	...
	my_application() : max_height_(6.0f), height_step_(0.15f)
	{
	}
...
#pragma region Program
	...
	void InitializeProgram()
	{
		...
		const char* tess_evaluation_shader_source[] =
		{
			...
			"																							\n"
			"layout (location = 0) uniform mat4 mvp_matrix;												\n"
			"layout (location = 1) uniform float max_height;											\n"
			"																							\n"
		...
		glAttachShader(render_program_, tess_control_shader);
		glAttachShader(render_program_, tess_evaluation_shader);
